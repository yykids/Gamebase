...
- [SDK] 2.19.0
  - (Unity) Fixed the issue where OutOfMemoryException occurs upon the reattempt in WebSocket
- [SDK] 2.19.1
  - (Android) Fixed the issue where it crashes when trying to log in with another IdP after Weibo login
